/*
 * sv08-bindings.h - Unified bindings header for Sovol SV08 (Allwinner H616)
 * Centralizes all dt-bindings to keep the main DTSI clean.
 */

#ifndef _DT_SV08_UNIFIED_H
#define _DT_SV08_UNIFIED_H
